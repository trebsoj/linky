    ...
    <div class="space-y-12">
        ...
        @if(count($links) == 0)
            <div class="text-center py-12">
                ...
                <p class="text-gray-500 dark:text-gray-400 text-lg">No links found</p>
                <p class="text-gray-400 dark:text-gray-500 text-sm">Create your first link to get started</p>
            </div>
        @endif
    </div>
    </div>
