...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2">
        <form action="{{route('link.update', $link->id)}}" method="POST" class="bg-white rounded-lg shadow-md p-6 border border-gray-200 space-y-6" novalidate>
            @method('PUT')
            @csrf

            <!-- Link Name -->
            <div>
                <label for="vLinkName" class="block text-sm font-semibold text-gray-700 mb-2">Link Name</label>
            ...
            <!-- Link URL -->
            <div>
                <label for="vLinkHref" class="block text-sm font-semibold text-gray-700 mb-2">Link URL</label>
            ...
            <!-- Redirect Code -->
            <div>
                <label for="vLinkCode" class="block text-sm font-semibold text-gray-700 mb-2">
                    Redirect Code
                ...
                <p class="text-xs text-gray-500 mt-1">
                    Access via: <code class="bg-gray-100 px-2 py-1 rounded text-blue-700">{{$hostname}}/r/{{$link->code}}</code>
                </p>
            </div>
            ...
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <label for="vPublic" class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="font-medium text-gray-700">Make this link public</span>
                </label>
            </div>
