    ...
    <form action="{{route('link.store')}}" method="POST" class="grid grid-cols-1 md:grid-cols-6 gap-3" novalidate>
        ...
        <div>
            <input type="text" name="code" placeholder="Redirect code" 
                class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition text-sm"
                id="vLinkCode"
            >
        </div>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b border-gray-200">
                    ...
                    <th class="px-6 py-3 text-center text-xs font-semibold text-gray-700 uppercase tracking-wider">Privacy</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        <a href="{{$item->href}}" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-700 hover:underline">
                            {{$item->name}}
                        </a>
                    </td>
...
<div class="text-center py-12 bg-white rounded-lg border border-gray-200">
    <i class="fas fa-link text-gray-300 text-5xl mb-4 block"></i>
    <p class="text-gray-500 text-lg font-medium">No links in this group</p>
    <p class="text-gray-400 text-sm">Create your first link using the form above</p>
</div>
@endif
