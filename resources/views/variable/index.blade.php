...
<div class="mb-6">
    ...
    <p class="text-gray-600 mt-2">Define global variables to use in your links</p>
</div>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">
                        <code class="bg-gray-100 px-2 py-1 rounded text-xs text-blue-700">{{$item->key}}</code>
                    </td>
...
<div class="text-center py-12 bg-white rounded-lg border border-gray-200">
    <i class="fas fa-dollar-sign text-gray-300 text-5xl mb-4 block"></i>
